  ...
  schemas:
	...
	for _, testcase := range []struct {
		...
		},
		{
			endpoint:   "/oauth2/any-token",
			ct:         "application/json",
			data:       `{"grant_type":"invalid_grant", "extra_field":"extraValue"}`, // Invalid grant_type
			shouldFail: true,
		},
		{
...

		{
			endpoint:   "/oauth2/all-token",
			ct:         "application/json",
			data:       `{"grant_type":"invalid", "client_id":"myclient", "extra_field":"extraValue"}`, // Invalid grant_type
			shouldFail: true,
		},
